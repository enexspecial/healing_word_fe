...
import { Heart, Users, Calendar, MapPin, Phone, Mail, Cross, BookOpen, Music } from 'lucide-react'
          ...
          <div className="text-center max-w-6xl mx-auto">
            ...
            <div className="mb-8 flex justify-center">
              <div className="relative w-48 h-48 md:w-64 md:h-64">
                <Image
                  src="/images/logo.png"
                  alt="Healing Word Christian Church Inc."
                  fill
            ...
            <p className="text-lg md:text-xl mb-8 text-blue-200 animate-slide-up max-w-3xl mx-auto">
              A place of hope, healing, and community where everyone belongs. 
              Join us as we grow in faith, love, and service to God and our community.
            </p>
            ...
            <div className="grid md:grid-cols-3 gap-6 max-w-4xl mx-auto">
              ...
              <div className="flex items-center justify-center gap-3">
                ...
                <div>
                  ...
                  <div className="text-sm">123 Church Street, Your City</div>
                </div>
              </div>
              <div className="flex items-center justify-center gap-3">
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            <div className="text-center p-6 rounded-lg bg-gradient-to-br from-green-50 to-green-100">
              ...
              <h3 className="text-xl font-semibold text-gray-900 mb-2">Outreach</h3>
        ...
        <div className="container-custom">
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-12">
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-blue-50 to-blue-100">
              ...
              <div className="text-sm text-blue-600 font-semibold">6 Resources Available</div>
            </div>
            ...
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-green-50 to-green-100">
              ...
              <div className="text-sm text-green-600 font-semibold">4 Resources Available</div>
            </div>
            ...
            <div className="text-center p-8 rounded-xl bg-gradient-to-br from-purple-50 to-purple-100">
              ...
              <div className="text-sm text-purple-600 font-semibold">8 Resources Available</div>
            </div>
          </div>
            ...
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-gray-700">info@healingwordchurch.com</span>
                </div>
                <div className="flex items-center gap-3">
                  <MapPin className="w-5 h-5 text-blue-600" />
                  <span className="text-gray-700">123 Church Street, Your City, ST 12345</span>
                </div>
              </div>
            </div>
            <div className="bg-white p-8 rounded-xl shadow-lg">
              ...
              <div className="space-y-4">
                <div className="flex justify-between items-center py-2 border-b border-gray-200">
                  ...
                  <span className="text-blue-600 font-semibold">9:00 AM & 11:00 AM</span>
                </div>
                <div className="flex justify-between items-center py-2 border-b border-gray-200">
